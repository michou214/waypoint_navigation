...
#define NB_CYCLE 3
#define W 0.5 // Spacing in the trajectory generation, see drawing /!\ Pay attention to the direction of axis
#define L 0.5 // Spacing in the trajectory generation, see drawing /!\ Pay attention to the direction of axis
